...
import 'page_social_model.dart';
export 'page_social_model.dart';
...
/// hierarchy.
class PageSocialWidget extends StatefulWidget {
  const PageSocialWidget({super.key});

  static String routeName = 'PageSocial';
  static String routePath = 'pageSocial';

  @override
  State<PageSocialWidget> createState() => _PageSocialWidgetState();
}

class _PageSocialWidgetState extends State<PageSocialWidget> {
  late PageSocialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageSocialModel());
