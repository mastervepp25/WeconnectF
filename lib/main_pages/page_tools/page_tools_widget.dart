...
import 'page_tools_model.dart';
export 'page_tools_model.dart';
...
/// hierarchy.
class PageToolsWidget extends StatefulWidget {
  const PageToolsWidget({super.key});

  static String routeName = 'PageTools';
  static String routePath = 'pageTools';

  @override
  State<PageToolsWidget> createState() => _PageToolsWidgetState();
}

class _PageToolsWidgetState extends State<PageToolsWidget> {
  late PageToolsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageToolsModel());
